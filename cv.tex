...
% TODO define the dates on right hand side as a proper column so descriptions don't run into that column
...
% Whether to add more detailed descriptions to entries
\longtrue
...
\EducationEntry{Master Artificial Intelligence}{2019-2022}{Radboud University}{GPA: 8.7\footnote{On a scale from 1 to 10.}, \emph{Cum laude}}
...
\EducationEntry{Research Master Philosophy}{2014-2020}{Radboud University}
...
\EducationEntry{Bachelor Artificial Intelligence}{2016-2019}{Radboud University}
...
\EducationEntry{Honours Programme Philosophy, Theology\\ and Religious Studies}{2012-2014}{Radboud University}{N/A}{On Schopenhauer's pessimistic metaphysics\\ Supervisor: Prof. dr. Ger Groot}

% NOTE do not split up entry over two pages
% TODO way to do this automatically?
%\newpage

\EducationEntry{Bachelor Philosophy}{2011-2014}{Radboud University}{GPA: 8.8, \emph{Cum laude}}{Thesis title: \textit{Van Stem naar Arche-Schrift: Deconstructie in} De la Grammatologie\\
Supervisor: Prof. dr. Philippe van Haute}

\EducationEntry{Gymnasium}{2005-2011}{Thomas a Kempis college, Arnhem}{GPA: 8.5}{Graduated in two curricula: Nature and Technology, Nature and Health.}
...
\WorkEntry{Data Expert Advanced Analytics}{Oct.2022-Now}{NS: Netherlands Railways}{The data expert function entails both data science and data engineering. We work DevOps and manage our own cloud infrastructure. We for example use data to enhance the planning of trains or to more accurately predict train delays.}
...
\SkillsEntry{Programming Languages}{\textbf{\emph{Experienced:}} Python \halfpipe \textbf{\emph{Familiar:}} R \halfpipe Java \halfpipe Bash \halfpipe SQL \halfpipe \LaTeX}
...
\SkillsEntry{Software dev.}{Programming paradigms \halfpipe Git \halfpipe CLI \halfpipe DevOps \halfpipe Agile \halfpipe Docker \halfpipe Unix \halfpipe Vim}
