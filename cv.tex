...
\PersonalEntry{Domain}{\url{https://www.edwinwenink.xyz}}
...
\EducationEntry{Master Artificial Intelligence}{2019-Present}{Radboud University}{Specialisation: Intelligent Technology\\
Current average: 8.6}
...
In cooperation with Wolters Kluwer \\
Judicium: Cum laude}
...
\WorkEntry{Graduate Research Intern Explainable AI}{Sep.2021-Present}{TNO}{I'm currently writing my master thesis AI at TNO, working on explainable recommendation of case law using text mining, embeddings, and counterfactual explanations.}

\sepspace

\WorkEntry{Intern Innovation Platform}{Mar.2021-Aug.2021}{Nederlandse Spoorwegen}{I helped realize an ethical approach to AI at NS by 1) working on AI policy and making it applicable to developers (ethics by design) and 2) researching tools and techniques for implementing values such as explainability and fairness.}
